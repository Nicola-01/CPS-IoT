...
def attacker(canBus: 'CanBus', frame: 'Frame', clock):
    clock.wait()
...
def victim(canBus: 'CanBus', frame: 'Frame', clock):
    clock.wait()
...
if __name__ == "__main__":
    ...
    attacker_thread = threading.Thread(target=attacker, args=(canBus, attackerFrame, clock))
    victim_thread = threading.Thread(target=victim, args=(canBus, victimFrame, clock))
